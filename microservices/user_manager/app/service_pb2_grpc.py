...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CheckUserExists = channel.unary_unary(
                '/service.UserService/CheckUserExists',
...
class DataCollectorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteUserInterests = channel.unary_unary(
                '/service.DataCollectorService/DeleteUserInterests',
                request_serializer=service__pb2.UserRequest.SerializeToString,
                response_deserializer=service__pb2.DeleteInterestsResponse.FromString,
                _registered_method=True)
...
def add_DataCollectorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'DeleteUserInterests': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.UserRequest.FromString,
                    response_serializer=service__pb2.DeleteInterestsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'service.DataCollectorService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('service.DataCollectorService', rpc_method_handlers)
...
class DataCollectorService(object):
    ...
    def DeleteUserInterests(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/service.DataCollectorService/DeleteUserInterests',
            service__pb2.UserRequest.SerializeToString,
            service__pb2.DeleteInterestsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
